...
# vector = Vector(Point(randrange(10), randrange(10)))
# print(vector)
# print(vector[0])
# print(vector[1])
...
users = {
        'John': 'Contact name: John, phones: 1234567890, birthday: 21.12.1987',
        'Jin': 'Contact name: Jin, phones: 1234567880, birthday: 15.12.1987',
        'Joe': 'Contact name: Joe, phones: 1234567890, birthday: 19.12.1987'
        }
...
def get_upcoming_birthdays(users, days=7):
    ...
    today = date.today()
    for key in users:
        _, birthday = users.get(key).split("birthday: ")
        birthday_this_year = string_to_date(birthday).replace(year=today.year)
        if birthday_this_year < today:
